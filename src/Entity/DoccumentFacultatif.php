...
/**
 * @ORM\Entity(repositoryClass="App\Repository\DoccumentFacultatifRepository")
 */
class DoccumentFacultatif
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CategorieVisa", inversedBy="doccumentsFacultatifs")
     */
